...
namespace plog
{
    ...
    class RTSoftTxtFormatter : public RTSoftTxtFormatterImpl<false> {};
    class RTSoftTxtFormatterUtcTime : public RTSoftTxtFormatterImpl<true> {};
}
